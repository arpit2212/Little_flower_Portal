...
const PrincipalClassStudents = () => {
  ...
  const fetchStudents = async () => {
    try {
      ...
      alert('Failed to load students. Please check database connection.');
    } finally {
      setLoading(false);
    }
  };
  ...
  const reorderStudents = async (cid) => {
    try {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const classSession = classInfo?.session || null;
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-gray-800">
            {classInfo?.name} {classInfo?.session && `- ${classInfo.session}`}
          </h2>
        ...
        <button
          ...
          className="flex items-center px-3 py-1.5 text-xs sm:text-sm rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-100 self-start"
        >
            ...
            <div className="border-t border-gray-200 pt-4">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                ...
                <button
                  ...
                  disabled={photoFolderUploading || photoFolderFiles.length === 0}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Samagra ID</label>
                  <input
                    type="text"
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Other Contact Number</label>
                  <input
                    type="tel"
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">RTE</label>
                  <select
                    value={formData.rte}
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Appar ID</label>
                  <input
                    type="text"
